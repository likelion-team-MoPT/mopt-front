  ...
  if (isLoading) {
    return (
      <Layout showBottomTab={false}>
        <Header title="캠페인 상세" backgroundColor="bg-zinc-50" />
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center ${getPlatformBgColor(campaign.channel)}`}
                >
                  <img
              ...
              <div
                className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(campaign.status)}`}
              >
